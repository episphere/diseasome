				...
				<table class="table table-sm table-striped table-bordered align-middle">
					<thead  class="table-dark">
						<tr>
							...
							<th ${sortAttrs('weighttype')} title="weight_type reported by the PGS Catalog (NR = not reported)">Weight Type${sortArrow('weighttype')}</th>
...
//# sourceMappingURL=displayScores-DgF8Gfp2.mjs.map
