...
const PGS_COL_HELP = {
	...
	weightType: "How the effect weights were derived, as reported to the PGS Catalog (e.g. beta, log(OR), log(HR)). NR = not reported; never inferred from the weights themselves.",
...
//# sourceMappingURL=displayScores-C4OWrZxR.mjs.map
